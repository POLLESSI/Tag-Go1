...
namespace Tag_Go.DAL.Interfaces
{
    public interface INEvenementRepository
    {
        ...
        NEvenement? Update(DateTime nEvenementDate, string nEvenementDescription, string posLat, string posLong, string positif, int organisateur_Id, int nIcon_Id, int recompense_Id, int bonus_Id, int mediaItem_Id, int nEvenement_Id);
    }
}
