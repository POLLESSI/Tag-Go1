...
namespace Tag_Go.DAL.Repositories
{
    public class NEvenementRepository : INEvenementRepository
    {
        ...
        public NEvenement? Update(DateTime nEvenementDate, string nEvenementDescription, string posLat, string posLong, string positif, int organisateur_Id, int nIcon_Id, int recompense_Id, int bonus_Id, int mediaItem_Id, int nEvenement_Id)
        {
            try
            {
                ...
                DynamicParameters parameters = new DynamicParameters();
                parameters.Add("@nEvenementDate", nEvenementDate);
                parameters.Add("@nEvenementDescription", nEvenementDescription);
                ...
                parameters.Add("@nIon_Id", nIcon_Id);
