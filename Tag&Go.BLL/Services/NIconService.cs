...
namespace Tag_Go.BLL.Services
{
    public class NIconService : INIconService
    {
        ...
        public NIcon? Delete(int nIcon_Id)
        {
            try
            {
                return _nIconRepository.Delete(nIcon_Id);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<NIcon?> GetAll()
        {
            return _nIconRepository.GetAll();
        }

        public NIcon? GetById(int nIcon_Id)
        {
            try
            {
                return _nIconRepository.GetById(nIcon_Id);
            }
            catch (Exception ex)
            {
        ...
        public NIcon? Update(string nIconName, string nIconDescription, string nIconUrl, int nIcon_Id)
        {
            try
            {
                var UpdateNIcon = _nIconRepository.Update(nIconName, nIconDescription, nIconUrl, nIcon_Id);
                return UpdateNIcon;
            }
